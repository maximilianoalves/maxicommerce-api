 ...
 *
 * @apiSuccess {number} id ID of a specific product that matches search criteria
 * @apiSuccess {String} name Name of a specific product.
 * @apiSuccess {String} price Price of a specific product.
 * @apiSuccess {String} formmatedPrice Formmated price of a specific product.
 * @apiSuccess {String} quantity Quantity of stock of product.
 * 
